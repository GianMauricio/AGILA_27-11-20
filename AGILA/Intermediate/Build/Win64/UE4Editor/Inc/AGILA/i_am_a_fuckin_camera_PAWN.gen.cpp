...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_MAX_HEALTH;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_Ai_am_a_fuckin_camera_PAWN_Statics::NewProp_MAX_HEALTH_MetaData[] = {
		{ "Category", "i_am_a_fuckin_camera_PAWN" },
		{ "ModuleRelativePath", "i_am_a_fuckin_camera_PAWN.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_Ai_am_a_fuckin_camera_PAWN_Statics::NewProp_MAX_HEALTH = { "MAX_HEALTH", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Ai_am_a_fuckin_camera_PAWN, MAX_HEALTH), METADATA_PARAMS(Z_Construct_UClass_Ai_am_a_fuckin_camera_PAWN_Statics::NewProp_MAX_HEALTH_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_Ai_am_a_fuckin_camera_PAWN_Statics::NewProp_MAX_HEALTH_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_Ai_am_a_fuckin_camera_PAWN_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_Ai_am_a_fuckin_camera_PAWN_Statics::NewProp_MAX_HEALTH,
	...
	IMPLEMENT_CLASS(Ai_am_a_fuckin_camera_PAWN, 3470175514);
